...
void USART2_Puts(char * str)
{
	 ...
	 /* Loop until the end of transmission */
	 while (USART_GetFlagStatus(USART2, USART_FLAG_TXE) == RESET); //??英文?考的521?，?TXE被置起?，一??据??完成
	 }
}

/*************************************************
Function: void USART3_Puts(char * str) 
Description: USART3?送?据            
Input: 待?送?据指?                  
Output:?                              
Return:?                              
*************************************************/
void USART3_Puts(char * str)
{
	 ...
	 /* Loop until the end of transmission */
	 while (USART_GetFlagStatus(USART3, USART_FLAG_TXE) == RESET); //??英文?考的521?，?TXE被置起?，一??据??完成
	 }
}

/*************************************************
Function: void USART4_Puts(char * str) 
Description: USART4?送?据            
Input: 待?送?据指?                  
Output:?                              
Return:?                              
*************************************************/
void USART4_Puts(char * str)
{
	 ...
	 /* Loop until the end of transmission */
	 while (USART_GetFlagStatus(UART4, USART_FLAG_TXE) == RESET); //??英文?考的521?，?TXE被置起?，一??据??完成
	 }
}
/*************************************************
Function: void UART5_Puts(char * str) 
Description: UART5?送?据            
Input: 待?送?据指?                  
Output:?                              
Return:?                              
*************************************************/
void UART5_Puts(char * str)
{
	 ...
	 /* Loop until the end of transmission */
	 while (USART_GetFlagStatus(UART5, USART_FLAG_TXE) == RESET); //??英文?考的521?，?TXE被置起?，一??据??完成
	 }
}

/*************************************************
Function: void USART6_Puts(char * str) 
Description: USART6?送?据            
Input: 待?送?据指?                  
Output:?                              
Return:?                              
*************************************************/
void USART6_Puts(char * str)
{
	 ...
	 /* Loop until the end of transmission */
	 while (USART_GetFlagStatus(USART6, USART_FLAG_TXE) == RESET); //??英文?考的521?，?TXE被置起?，一??据??完成
	 }
}
