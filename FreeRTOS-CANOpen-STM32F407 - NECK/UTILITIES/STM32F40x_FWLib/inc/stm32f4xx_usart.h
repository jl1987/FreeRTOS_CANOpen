...
void USART1_Puts(char * str);	// Send String through USART1
void USART3_Puts(char * str);	// Send String through USART3
void USART4_Puts(char * str);	// Send String through USART4
void USART6_Puts(char * str);	// Send String through USART6
